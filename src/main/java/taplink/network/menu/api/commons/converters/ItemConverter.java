...
public class ItemConverter {
    ...
    public Item convertToNewEntityFromDto(ItemRequestDto dto, Category category) {
        Item item = objectMapperUtils.convertEntityAndDto(dto, Item.class);
        item.setCategory(category);
        return item;
    }

    public void convertToPersistedEntityFromDto(Item item, ItemRequestDto dto, Category category) {
